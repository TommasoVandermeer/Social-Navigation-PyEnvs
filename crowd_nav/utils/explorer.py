        ...
        for i in range(k):
            ...
            while (not terminated) and (not truncated):
                if imitation_learning:
                    ...
                    # Save states and rewards in an output file for benchmarking
                    # if i < 100:
                    #     states_to_be_saved.append([state.self_state.px, state.self_state.py, state.self_state.vx, state.self_state.vy])
                    #     for human_state in state.human_states: states_to_be_saved.append([human_state.px, human_state.py, human_state.vx, human_state.vy])

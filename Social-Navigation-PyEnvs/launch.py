...
social_nav = SocialNav([7,6,False,"hsfm_new_guo",False,True,False],mode="circular_crossing")
...
# social_nav.run_multiple_models_test(final_time=20, models=["hsfm_new_guo"], plot_sample_time=3, two_integrations=True)

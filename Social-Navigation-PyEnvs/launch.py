...
# social_nav.run_multiple_models_test(final_time=20, models=models, plot_sample_time=3, two_integrations=True)
# Run complete simulation with RK45 integration, get human states a posteriori and print them
# social_nav.run_complete_rk45_simulation(final_time=20, sampling_time=1/50, plot_sample_time=3)

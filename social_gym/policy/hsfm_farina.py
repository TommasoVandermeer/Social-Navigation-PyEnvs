import numpy as np
from social_gym.policy.forces import compute_desired_force, compute_social_force_helbing as compute_social_force, compute_torque_force_farina
...
class HSFMFarina(Policy):
    ...
    def predict(self, state):
        ...
        torque_force = compute_torque_force_farina(self.params, self_state, inertia, desired_force)

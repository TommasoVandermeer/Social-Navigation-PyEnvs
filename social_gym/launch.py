...
# social_nav = SocialNavSim(config_data = {"insert_robot": False, "human_policy": "sfm_guo", "headless": True,
...
# social_nav.set_robot_policy(policy_name="lstm_rl", crowdnav_policy=True, model_dir=os.path.join(os.path.dirname(__file__),'robot_models/trained_on_hybrid_scenario/lstm_rl_on_sfm_guo'), il=False)

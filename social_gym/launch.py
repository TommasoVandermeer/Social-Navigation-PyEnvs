...
social_nav.set_robot_policy(policy_name="sarl", crowdnav_policy=True, model_dir=os.path.join(os.path.dirname(__file__),'robot_models/trained_on_parallel_traffic/sarl_on_sfm_guo'), il=False)
...
# models = ["hsfm_farina", "hsfm_guo", "hsfm_new_guo"]
